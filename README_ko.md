...
*필수: [Node.js](https://nodejs.org/) (v18+) 및 [npm으로 설치한 Claude Code CLI](https://docs.anthropic.com/en/docs/claude-code) (`npm install -g @anthropic-ai/claude-code`)*

> **참고:** 네이티브 인스톨러(`curl -fsSL https://claude.ai/install.sh | bash`)는 **지원하지 않습니다**. 번역 훅이 동작하려면 Claude Code를 npm으로 설치해야 합니다.
